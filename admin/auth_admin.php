...
<aside class="adm-sidebar">
  ...
  <nav class="adm-nav">
    ...
    <a href="/admin/wolt_scraper.php" class="<?php echo $active==='wolt_scraper'?'active':''; ?>">
      <svg class="adm-nav-icon" viewBox="0 0 16 16" fill="none"><path d="M8 1l2 4 5 .7-3.5 3.4.8 5L8 11.5 2.7 14.1l.8-5L0 5.7 5 5z" stroke="currentColor" stroke-width="1.2"/></svg>
      Wolt Scraper
    </a>
    <a href="/admin/scraper.php"  class="<?php echo $active==='scraper'?'active':''; ?>">
      <svg class="adm-nav-icon" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6" stroke="currentColor" stroke-width="1.5"/><path d="M8 5v3l2 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
      Price Scraper
    </a>
